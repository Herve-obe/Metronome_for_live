...
abstract class $ProjectCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, List<Song> songs, List<Setlist> setlists});
}
...
class _$ProjectImpl implements _Project {
  const _$ProjectImpl({
    ...
    final List<Setlist> setlists = const [],
  }) : _songs = songs,
       _setlists = setlists;
  ...
  List<Setlist> get setlists {
    if (_setlists is EqualUnmodifiableListView) return _setlists;
    // ignore: implicit_dynamic_type
  ...
  @override
  String toString() {
    return 'Project(id: $id, name: $name, songs: $songs, setlists: $setlists)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other._setlists, _setlists));
  }
  ...
  int get hashCode => Object.hash(
    ...
    const DeepCollectionEquality().hash(_setlists),
  );
